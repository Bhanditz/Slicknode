...
/**
 * An [Observable] which is notified when capabilities are added to or removed from the Wear network.
 */
class CapabilitiesListenerObservable : Observable<CapabilityInfo> {

  constructor(googleApiClient: GoogleApiClient, uri: Uri, filter: Int) : super(OnSubscribe {
    ...
    CapabilityApi.addListener(googleApiClient, listener, uri, filter)
